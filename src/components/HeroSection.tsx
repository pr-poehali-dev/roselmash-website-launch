...
const HeroSection = () => {
  return (
    <section className="relative bg-gradient-to-br from-green-500 to-blue-600 text-white py-20 px-4 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto text-center">
        ...
        <h1 className="text-5xl md:text-6xl font-bold mb-6 font-montserrat">
          ...
          <br />
          <span className="text-yellow-300">машиностроения</span>
        </h1>
